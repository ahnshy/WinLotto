...
{	CRect rc;
	...
	//const COLORREF clrBack = (active ? RGB(255,232,166) : RGB(206,212,223)); // Ahnshy
	const COLORREF clrBack = DEFAULT_BACKGROUND_COLOR;
	...
	const bool anyButtonsVisible = !ctrl->GetButtonCloseRect().IsRectEmpty() || !ctrl->GetButtonMenuRect().IsRectEmpty() ||
		...
		// 
		// draw top.
	rc.SetRect(rect->left,rect->top,rect->right,rect->top+4);	// Ahnshy
	FillSolidRect(dc,&rc,clrBack);// Ahnshy

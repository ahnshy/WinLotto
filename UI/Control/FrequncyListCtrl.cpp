// CFrequncyListCtrl.cpp : implementation file
//

#include "stdafx.h"
#include "FrequncyListCtrl.h"
...
int CFrequncyListCtrl::OnCompareItems(LPARAM lParam1, LPARAM lParam2, int iColumn)
{
...
COLORREF CFrequncyListCtrl::OnGetCellBkColor(int nRow, int nColum)
{

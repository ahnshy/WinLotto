...
/////////////////////////////////////////////////////////////////////////////
// CPageWinsFrequencyList dialog
class CPageWinsFrequencyList : public CDialogEx
{
	DECLARE_DYNCREATE(CPageWinsFrequencyList)

public:
	CPageWinsFrequencyList();   // standard constructor
	~CPageWinsFrequencyList();
